(function TypoExpressionTransform(thisObj) {
  ...
  function TypoExpressionTransform_doIt() {
    ...
    if (!isPartsCtlIn) {
      ...
      opacityRatio.property("ADBE Slider Control-0001").setValue(100);
      ...
      pxRatio.property("ADBE Slider Control-0001").setValue(100);
      ...
      pxDistMax.property("ADBE Slider Control-0001").setValue(30);
      ...
      pyRatio.property("ADBE Slider Control-0001").setValue(100);
      ...
      pyDistMax.property("ADBE Slider Control-0001").setValue(30);
      ...
      rotRatio.property("ADBE Slider Control-0001").setValue(100);
      ...
      rotMax.property("ADBE Slider Control-0001").setValue(20);
      ...
      randSeeds.property("ADBE Slider Control-0001").setValue(1);
      ...
      randDirection.property("ADBE Checkbox Control-0001").setValue(0);
    ...
    for (var i = 0; i < selLayers.length; i++) {
      ...
      try {
        ...
        l.transform.position.expression =
          'var rdsd = Math.abs( Math.floor( thisComp.layer("PartsController").effect("Random_seed")("ADBE Slider Control-0001") ) ); \n' +
          "seedRandom(rdsd, true); \n" +
          'var maxdist_x = thisComp.layer("PartsController").effect("PositionX_maxDist")("ADBE Slider Control-0001"); \n' +
          'var maxdist_y = thisComp.layer("PartsController").effect("PositionY_maxDist")("ADBE Slider Control-0001"); \n' +
          'var mindist_x = maxdist_x / 2.; \n' +
          'if (thisComp.layer("PartsController").effect("Random_Direction(Off:UniDir_On:BiDir)")("ADBE Checkbox Control-0001")==1) { \n' +
          "mindist_x = -mindist_x } \n" +
          ...
          'var ratio_x = (100. - thisComp.layer("PartsController").effect("PositionX_ratio(%)")("ADBE Slider Control-0001").valueAtTime(time-inPoint)) / 100.; \n' +
          'var ratio_y = (100. - thisComp.layer("PartsController").effect("PositionY_ratio(%)")("ADBE Slider Control-0001").valueAtTime(time-inPoint)) / 100.; \n' +
        ...
        //   'var rdsd = Math.abs( Math.floor( thisComp.layer("PartsController").effect("Random_seed")("ADBE Slider Control-0001") ) ); \n' +
        //   "seedRandom(rdsd, true); \n" +
        //   'var maxrot = thisComp.layer("PartsController").effect("Rotation_maxRot")("ADBE Slider Control-0001"); \n' +
        //   'var ratio_rot = (100. - thisComp.layer("PartsController").effect("Rotation_ratio(%)")("ADBE Slider Control-0001").valueAtTime(time-inPoint)) / 100.; \n' +
        ...
        l.transform.opacity.expression =
          "seedRandom(1, true); \n" +
          'transform.opacity = thisComp.layer("PartsController").effect("Opacity")("ADBE Slider Control-0001").valueAtTime(time-inPoint);';
